...
layout(location = 3) in mat4 instanceMatrix; //uses locations 3-6
...
out vec3 fColor; //to frag shader
...
void main() {
	...
	gl_Position = uProjectionMatrix * uModelViewMatrix * instanceMatrix * vec4(aPosition, 1);
}