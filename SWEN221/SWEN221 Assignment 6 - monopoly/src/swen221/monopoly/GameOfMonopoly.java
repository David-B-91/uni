...
public class GameOfMonopoly {
	 ...
	 * @throws InvalidMove 
	 */
	public void movePlayer(Player player, int diceRoll) throws InvalidMove {
		
		if (diceRoll > 12 || diceRoll < 2) {
			throw new InvalidMove("dice roll higher than 12 or less than 2");
		}
	...
	/**
	 * Allow player to unmortgage a property. Only allowed if property actually
