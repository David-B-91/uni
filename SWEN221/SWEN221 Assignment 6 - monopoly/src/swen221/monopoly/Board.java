 ...
 * at a given position on the board. Positions are taken in anti-clockwise order
 * relative to the special location "Go" which is considered position "0". Thus,
 * position 1 is "Old Kent Road", position 2 is "Community Chest", etc.
 *
...
public class Board {
	...
	public Board() {
		...
		Street pentonville = new Street("Pentonville Road", 120, 9);
	...
	/**
	 * Find location which is a given number of steps along from the given
	 * location argument. Steps are counted in an anti-clock wise fashion, as
	 * this follows the direction in which the Monopoly game is played.
	 */
	...
	/**
	 * Find location with the given name, or return null if no such location
	 * exists.
	 */
