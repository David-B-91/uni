...
def main(net):
    ...
    host_ipv6_address = get_ipv6_addr(preferences.Preferences, network_interface)
    ...
    app = DataApplication(neighbors=neighbors, ip_version=Ipv.both)
    ...
    while True:
        ...
        try:
            ...
            # re-enable IPv6
            # os.system("sysctl net.ipv6.conf.{}.disable_ipv6=0".format(iface_name))
            break
